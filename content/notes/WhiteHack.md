...
В системе присутсвуют **критические провалы (fumble)** (выбрасывание 20 на кубике) и **критические успехи (crit)** (выбрасывание на кубике значения, равного целевому значению). 
...
Пример групп: *Эльфийский боец - член Тайного Братства*, является персонажем [[#Вид (Species)|рассовой группы (species)]] эльф, [[#Призвания (Vocations)|призвания (vocation)]] боец и [[#Принадлежности (Affilations)|принадлежит (affilations)]] к Тайному Братству. 
...
Когда они получают **слот (Sl.)**, они навсегда привязывают к ней два **чуда (miracles)** — одно активное (в слоте) и одно неактивное.
...
Существуют рекомендации по стоимости, основанные на **порядках вмешательства (*порядок вмешательста, магнитуда, magnitude)*** (см. [[#Порядки вмешательства|таблицу порядков вмешательства]]). Но затраты, как правило, немного меняются в зависимости от времени и места. 

Мудрый может один раз в день сэкономить HP и потратить 10 минут на обнаружение и использование локальной концентрации энергии, удешевляя одиночный эффект определенного типа на однин порядок вмешательства.
...
Нося щиты или доспехи тяжелее кожанных, Мудрые получают штраф +2 ко всем затратам HP (до любого увеличения или удвоения). 
...
Как только магия достаточно глубоко укоренилась в символах свитка, Мудрый может сохранить эффект в слот при успешной [[#Навыки и Тренированные броски (Skills and Trained rolls)|тренированной проверке интеллекта]]. **Уровень** Мудрого должен превышать стоимость **свитка в HP**, а свитку должно быть не менее десяти лет. 
...
При заполнении слота магическим предметом, все предыдущие формулировки (активная и неактивная), привязанные к слоту, разрушаются. 
...
По этой причине ловкие персонажи не отмечают группу призвания рядом с конкретным атрибутом. Кроме того, когда они имеют боевое преимущество (см. [[#Боевое преимущество (Combat Advantage)|Боевое Преимущество]]), ловкие персонажи могут поменять преимущество [[#Двойные броски|позитивного двойного броска]], полученное от своего класса, на двойной урон, если их призвание соответствует ситуации. 
...
У них есть бонусы СЛ против яда и смертельных угроз (+1) и специальные атаки ближнего боя (+4).
...
Обладая боевым преимуществом, [[#Ловкий (The Deft)|Ловкие]] персонажи всегда используют [[#Двойные броски|позитивный двойной бросок]], и могут вместо него нанести двойной урон, когда они попадают по противнику в соответствии с их призванием.

Если боевое преимущество, получаемое [[#Ловкий (The Deft)|Ловкими]] персонажами, связано с их призванием (vocation), они используют [[#Двойные броски|позитивный двойной бросок]] бросок для атаки, и могут заменить его на на **двойной урон.**
...
[^ext]: Подобная сноска обозначет, что данное правило было добавлено, и не совпадает с оригинальным изданием