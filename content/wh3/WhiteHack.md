...
Где фактически размещаются предметы в сумках, ножнах и разгрузках персонажа зависит от описания игрока, однако предметы, помещённые в "контейнер" нельзя быстро применить в бою. Для того, чтобы извлечь предмет из "контейнера", необходимо потратить не менее **3 раундов**. [^ext]
...
| ----- | ---------------------------------------------------------------------------------------------------- |
| 0     | Нокаутирован, пока не восстановится до положительного HP.                                            |
| < 0   | Нокаутирован, как описано выше, но также должен сделать спасбросок или умереть в течении d6 раундов. | 
| < -10 | Мгновенная, жуткая смерть.                                                                           |
...
- Однако, если спасбросок терпит неудачу, персонаж получает полный урон от атаки. При 0 HP персонаж нокаутирован. **Но если после получения урона, HP остаются, персонаж всё-равно в нокауте на два раунда.**
...
- Мастер может позволить персонажу перевязать раны на 1d6−3 HP сразу же после битвы с помощью [[#Навыки и Тренированные броски (Skills and Trained rolls)|тренированного броска задачи]]. 
...
Если кто-то использует особую способность оружия **нокаут (*knock-out)***, полученный урон не может убить, а только нокаутировать (иногда это называют «не смертельным» уроном). Это означает, что вы нормально лечитесь даже при отрицательном HP.
